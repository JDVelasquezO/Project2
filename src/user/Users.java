...
public class Users extends javax.swing.JFrame {
    ...
    public Users() {
        ...
        fillTableUsers(jTable1);
    }

    public void fillTableUsers(JTable tabla) {
        cleanTable(tabla);
        for (int i = 0; i < length; i++) {
            Object object = list.getValue(i);
            objectTemp = (User) object;
            String fullName = objectTemp.getName() + " " + objectTemp.getLast();
            int id = objectTemp.getId();
            addRowTableUsers(tabla, id, fullName);
        }
    }

    public static void addRowTableUsers(JTable tabla, int id, String fullName) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String msg = "Nombre completo: " + objectTemp.getName() + " " + objectTemp.getLast() + "\n" +
                    "Correo: " + objectTemp.getEmail() + "\n" + "Targeta de crédito: " + objectTemp.getCreditCard();
